...
interface PatientProviderProps { children: ReactNode; }
export const PatientProvider: React.FC<PatientProviderProps> = ({ children }) => { const [patients, setPatients] = useState<Patient[]>([]);
...
return (<PatientContext.Provider value={{ patients, addPatient, updatePatient, removePatient }}>{children}</PatientContext.Provider>); };